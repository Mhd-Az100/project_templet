import 'package:base_templet/core/api/dio_provider.dart';
...
Future<void> initGlobalGetIt() async {
  ...
  injection.registerLazySingleton(() => NetworkInfoImpl(injection()));
  injection.registerLazySingleton(() => DioProvider(injection(), injection()));
